...
const IndexPage = () => {
  ...
  return (
    <Layout>
      ...
      >
        <div
          className="inline-block text-xl lg:text-3xl mb-8"
          style={{ fontVariationSettings: "'wdth' 125, 'wght' 400" }}
        >
          <h1>
            Everything falls under the responsibility of{" "}
            <strong>cabinet</strong>. If you have any questions or concerns,
