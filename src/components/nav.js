...
const Nav = () => {
  ...
  return (
    <header
      id="header"
      className="lg:bg-transparent lg:h-screen fixed left-0 top-0 flex-none w-full lg:max-w-xs text-white z-50"
    >
        ...
        <div id="navstuff" className="lg:flex lg:flex-col lg:flex-grow hidden">
          <ul className="flex-grow mt-16">
            <li className="navlist">
              <Link to="/class" className="hoverlink">
                Class
              </Link>
            </li>
            <li className="navlist">
              <Link to="/cabinet" className="hoverlink">
                Cabinet
              </Link>
            </li>
            <li className="navlist">
              <Link to="/demos" className="hoverlink">
                Demos
              </Link>
            </li>
            <li className="navlist">
              <Link to="/contact" className="hoverlink">
                Contact
              </Link>
            </li>
          </ul>
          <footer className="mt-8">
            <div>
              <ul className="mb-4 text-gray-300">
                <li className="mt-1">
                  <a className="navlist2" href="https://linktr.ee/ucsdwushu">
                    LinkTree
                  </a>
                </li>
                <li className="mt-1">
                  <a
                    className="navlist2"
                    href="https://discord.com/invite/F6gSrcG"
                  >
                    Discord
                  </a>
                </li>
                <li className="mt-1">
                  <a
                    className="navlist2"
                    href="https://www.instagram.com/ucsdwushu/"
                  >
                    Instagram
                  </a>
                </li>
                <li className="mt-1">
                  <a className="navlist2">Facebook</a>
                </li>
                <li className="mt-1">
                  <a
                    className="navlist2"
                    href="https://www.youtube.com/channel/UCJJOaO7Kk3-u-qHxsRbrFuw"
                  >
                    YouTube
                  </a>
                </li>
              ...
              <p className="text-xs opacity-50 text-gray-400">
                © {new Date().getFullYear()} Wushu Club<br></br>@ UC San Diego
              </p>
